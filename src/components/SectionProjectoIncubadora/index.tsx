            ...
            <li>
              <section>
                ...
                <div>
                  ...
                  <p>
                    Auxiliar na realização do currículo das pessoas, dando
                    ênfase nos seus pontos fortes, habilidades e direcionando
                    para as profissões de acordo com cada perfil.
                  </p>
                  <p>
                    Proporcionar palestras de como vestir no trabalho, como se
                    comportar, como respeitar o próximo, o que é e como funciona
                    a hierarquia dentro da empresa, etc...
                  </p>
                ...
                <div>
                  ...
                  <p>
                    Serão realizados integração junto aos órgãos do governo
                    (SINE) e parcerias com empresas locais.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    Inicialmente serão por voluntários profissionais da
                    sociedade previamente acordados, pessoas que tenham o perfil
                    e conhecimento tais como: Administrador, psicólogos e ou
